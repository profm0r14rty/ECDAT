...
def export_html(result: ScanResult) -> str:
    ...
    # These two sections are assembled in plain locals rather than inline in the
    # f-string below: their join uses a backslash ("\n"), and a backslash may not
    # appear inside an f-string replacement field before Python 3.12 (PEP 701).
    if result.detections:
        detections_html = (
        ...
        detections_html = "<p>No detections found.</p>"
